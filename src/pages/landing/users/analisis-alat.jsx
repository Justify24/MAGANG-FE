...
import ResultCard from "../../../components/users-component/card/resultcard";
import StatusCard from "../../../components/users-component/card/rillstatuscard";
import FormInput from "../../../components/users-component/card/forminput";

const AnalisisAlat = () => {
  const status = "offline"; // Replace with dynamic status if needed
  const resultData = [
    { title: "Hasil PH", value: 85 },
    { title: "Hasil Kelembaban", value: 85 },
    { title: "Hasil EC", value: 85 },
    { title: "Hasil Suhu", value: 85 },
    { title: "Hasil N", value: 85 },
    { title: "Hasil P", value: 85 },
    { title: "Hasil K", value: 85 },
  ];
  return (
    <>
      <div
      ...
      >
        <div className="container mx-auto px-6 py-4">
          ...
          {/* Bottom Navigation */}
          {/* Result Cards */}
          <div className="container mx-auto px-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 pb-10">
            {resultData.map((data, index) => (
              <ResultCard key={index} title={data.title} value={data.value} />
            ))}
          </div>
          {/* Divider */}
          <div className="w-full border-t-2 border-gray-300 my-6"></div>
          <FormInput />
          {/* Divider */}
          <div className="w-full border-t-2 border-gray-300 my-6 pt-15"></div>
